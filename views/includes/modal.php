...
<div id="modalUpdate" class="modal" tabindex="-1">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="index.php?action=update&id=<?= $data['id'] ?>" method="post" onsubmit="return validateFormUpdate()">
      <div class="modal-body">
          <div class="row">
            <div class="col">
              <div class="form-group">
                <label>Nome completo</label>
                <input id="update_name" type="text" placeholder="Ex.: Cleiton dos Santos Cruz" class="form-control color__border" name="name" required>
              </div>
              <div class="form-group">
                <label>E-mail</label>
                <input id="update_email" type="text" placeholder="Ex.: cleitonncruz105@gmail.com" class="form-control" name="email" required>
              </div>
              <div class="form-group">
                <label>Telefone para contato</label>
                <input id="update_phone" type="text" placeholder="Ex.: (11)5787-1602" class="form-control" name="phone" onkeyup="formatPhone(this)" maxlength="14" required>
              </div>
            ...
            <div class="col">
              <div class="form-group">
                ...
                <input id="update_birth" type="text" placeholder="Ex.: 20/01/2001" class="form-control" name="birth"onkeyup="formatDOB(this)" maxlength="10" required>
              </div>
              <div class="form-group">
                <label>Profissão</label>
                <input id="update_profession" type="text" placeholder="Ex.: Desenvolvedor" class="form-control" name="profession" required>
              </div>
              <div class="form-group">
                <label>Celular para contato</label>
                <input id="update_celular" type="text" placeholder="Ex.: (11)95161-2029" class="form-control" name="celular" onkeyup="formatPhone(this)" maxlength="15" required>
              </div>
